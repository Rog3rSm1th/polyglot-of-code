class Day11Part2(var password: String) {
...
fun main(args: Array<String>) {
    val firstPassword = "hepxcrrq"
    val secondPassword = Day11Part2(firstPassword).solve()
    println(Day11Part2(secondPassword).solve())
}